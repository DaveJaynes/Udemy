...
namespace Files
{
    internal class CreateJsonOutput
    {
            ...
            Mapper mapper = new Mapper(new MapperConfiguration((cfg) =>
            {
                cfg.CreateMap<ComputerSnake, Computer>()
                    ...
                    .ForMember(destination => destination.firstName, options =>
                        options.MapFrom(source => source.FirstName))
                    .ForMember(destination => destination.lastName, options =>
                        options.MapFrom(source => source.LastName))
                    .ForMember(destination => destination.email, options =>
                        options.MapFrom(source => source.Email))
                    .ForMember(destination => destination.gender, options =>
                        options.MapFrom(source => source.Gender))
